    ...
    public class PartidaDeXadrez
    {
        ...
        public void realizaJogada(Posicao origem, Posicao destino)
        {
            ...
            if (estaEmXeque(jogadorAtual))
            {
                ...
                throw new TabuleiroException("Voçê Nao pode se colocar em Xeque! ");
            }
        ...
        public void validaPosicaoDeOrigem(Posicao pos)
        {
            ...
            {
                throw new TabuleiroException("A peça de origem escolhida nao e sua!");
            }
        ...
        private void colocarPecas()
        {
            ...
            colocarNovaPeca('k', 1, new Torre(tab, Cor.Branca));
            ...
            colocarNovaPeca('e', 7, new Rei(tab, Cor.Preta, this));
            colocarNovaPeca('f', 7, new Torre(tab, Cor.Preta));
            colocarNovaPeca('g', 7, new Bispo(tab, Cor.Preta));
            colocarNovaPeca('h', 7, new Cavalo(tab, Cor.Preta));
            ...
            colocarNovaPeca('h', 8, new Peao(tab, Cor.Preta, this));
        }
    }
}
